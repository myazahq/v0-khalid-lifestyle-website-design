			...
			<div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20">
				<div>
					...
					<p className="text-muted-foreground mb-12 max-w-md leading-relaxed">
						Interested in booking a table, organizing a private event, or
						collaborating with the brand? Fill out the form below.
					</p>
				...
				>
					<form className="space-y-6">
						...
						<div className="space-y-2">
							...
							<Textarea
								className="bg-transparent border-white/10 rounded-none min-h-37.5 focus-visible:ring-gold"
